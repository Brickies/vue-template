...
> A full-featured Webpack + vue-loader + vuex + axios setup with hot reload, linting, testing & css extraction.

> This template is Vue 2.0 compatible. For Vue 1.x use this command: `vue init Brickies/vue-template#1.0 my-project`

Chinese Doc : [中文文档](https://github.com/Brickies/vue-template/blob/project-ts/README.md)
